...
robotTag.setAttribute("src", "./asset/robot.svg");
humanTag.setAttribute("class", "imageSize");
humanTag.setAttribute("src", "./asset/question.svg");
...
actionGo.addEventListener("click", () => {
  ...
  if (humanState !== null) {
    ...
    setInterval(() => {
      ...
      robotTag.setAttribute("src", "./asset/" + option[i++] + ".svg");
    ...
    setTimeout(() => {
      ...
      if (comp < 0.34) {
        robotState = 0;
        robotTag.setAttribute("src", "./asset/rock.svg");
      } else if (comp >= 0.34 && comp < 0.67) {
        robotState = 1;
        robotTag.setAttribute("src", "./asset/paper.svg");
      } else {
        robotState = 2;
        robotTag.setAttribute("src", "./asset/scissor.svg");
      }
